...
SECRET_KEY = 'django-insecure-!rr-0o+%x=(i1#ws=6w&3q_+=k@bnw$jt(ce6mhb7+2mc@w#1('
...
INSTALLED_APPS = [
    ...
    'scrummaster.apps.ScrummasterConfig',
    'serviceintegrator.apps.ServiceintegratorConfig',
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost",
    "vscode-webview://1hud3nqcn28jmkvam3sthrkfeur1kd9f2956gl59q9v62121tlmu",
]
